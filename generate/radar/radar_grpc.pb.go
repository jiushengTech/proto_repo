...
const (
	Radar_CreateRadar_FullMethodName    = "/api.device.Radar/CreateRadar"
	Radar_UpdateRadar_FullMethodName    = "/api.device.Radar/UpdateRadar"
	Radar_DeleteRadar_FullMethodName    = "/api.device.Radar/DeleteRadar"
	Radar_ListRadar_FullMethodName      = "/api.device.Radar/ListRadar"
	Radar_GetRadarStatus_FullMethodName = "/api.device.Radar/GetRadarStatus"
	Radar_GetRadarTrack_FullMethodName  = "/api.device.Radar/getRadarTrack"
	Radar_GetRadarPlot_FullMethodName   = "/api.device.Radar/GetRadarPlot"
)
