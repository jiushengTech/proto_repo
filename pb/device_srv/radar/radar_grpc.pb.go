...
const (
	Radar_CreateRadar_FullMethodName    = "/biz.device_srv.device.Radar/CreateRadar"
	Radar_UpdateRadar_FullMethodName    = "/biz.device_srv.device.Radar/UpdateRadar"
	Radar_DeleteRadar_FullMethodName    = "/biz.device_srv.device.Radar/DeleteRadar"
	Radar_ListRadar_FullMethodName      = "/biz.device_srv.device.Radar/ListRadar"
	Radar_GetRadarStatus_FullMethodName = "/biz.device_srv.device.Radar/GetRadarStatus"
	Radar_GetRadarTrack_FullMethodName  = "/biz.device_srv.device.Radar/getRadarTrack"
	Radar_GetRadarPlot_FullMethodName   = "/biz.device_srv.device.Radar/GetRadarPlot"
)
...
var Radar_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "biz.device_srv.device.Radar",
